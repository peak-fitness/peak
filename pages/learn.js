    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.whyContent}>
          ...
          <p>
            We offer a variety of benefits and services so you can achieve your
            goals for the year! Lorem ipsum dolor sit amet, consectetur
        ...
        <div className={styles.offerContent}>
          ...
          <div className={styles.services}>
            <div className={styles.service}>
              ...
              <p>Find other passionate people to keep you going to the gym!</p>
            </div>
            <div className={styles.service}>
              <CalculateIcon
                color="secondary"
              ...
              <p>
                Need to keep track of calorie intake to diet or get big? We have
                you covered.
              </p>
            </div>
            <div className={styles.service}>
